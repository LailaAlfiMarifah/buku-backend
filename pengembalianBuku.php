...
$tanggal_pengembalian = isset($_POST['tanggal_pengembalian']) ? $_POST['tanggal_pengembalian'] : "2023-05-05";
$durasi_keterlambatan = isset($_POST['durasi_keterlambatan']) ? $_POST['durasi_keterlambatan'] : "5 Hari";

if ($id_peminjaman !== 1 && $id_peminjaman !== "" && $tanggal_pengembalian !== null && $tanggal_pengembalian !== "" && $durasi_keterlambatan !== null && $durasi_keterlambatan !== "") {
